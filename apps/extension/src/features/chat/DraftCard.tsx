/**
 * DraftCard — shows AI-generated content with Insert/Copy/Dismiss actions.
 */
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        <button
          ...
          style={{
            ...
            background: '#111', color: '#fff', cursor: 'pointer', border: 'none',
          }}
        >Insert</button>
        <button
          onClick={onCopy}
          style={{
            ...
            border: `1px solid ${COLORS.borderDivider}`, cursor: 'pointer',
          }}
        >Copy</button>
        <button
          onClick={onDismiss}
