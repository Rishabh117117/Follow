/**
 * UnitInputBar — input row with F icon, textarea, send/stop, minimize.
 */
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '10px 16px' }}>
      ...
      <textarea
        ...
        style={{
          ...
          border: 'none', outline: 'none', maxHeight: 80, minHeight: 22,
          fontFamily: 'inherit',
        }}
      ...
      {isStreaming ? (
        ...
        <button
          ...
          style={{
            ...
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            flexShrink: 0, opacity: inputValue.trim() ? 1 : 0.4,
